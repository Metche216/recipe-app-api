    ...
    list=extend_schema(
        parameters=[
            OpenApiParameter(
                'tags',
                OpenApiTypes.STR,
                description='Comma septarated list of IDs to filter',
            ),
            OpenApiParameter(
                'ingredients',
                OpenApiTypes.STR,
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self): #override the get methode for this viewset
        ...
        ).order_by('-id').distinct() #distintct avoids duplicate values, we want a return of unique values in the response.
